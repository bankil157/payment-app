    ...
    <div className="space-y-6">
          ...
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Select value={formData.paymentId} onValueChange={(value) => setFormData(prev => ({ ...prev, paymentId: value, invoiceId: '' }))}>
                  <SelectTrigger>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {invoices.filter(i => i.remainingAmount > 0).slice(0, 5).map(invoice => {
                const buyer = getBuyerById(invoice.buyerId);
                return (
              ...
              {invoices.filter(i => i.remainingAmount > 0).length === 0 && (
