  ...
  return (
    <div className="space-y-6 min-h-screen pb-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Welcome to your invoice accounting dashboard</p>
      </div>
                ...
                recentInvoices.map((invoice) => (
                  <div key={invoice.id} className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="min-w-0 flex-1">
                      <p className="font-medium truncate">{invoice.referenceNumber}</p>
              ...
              {recentPayments.length > 0 ? (
                recentPayments.map((payment) => (
                  <div key={payment.id} className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="min-w-0 flex-1">
                      <p className="font-medium truncate">{payment.referenceNumber}</p>
                      <p className="text-sm text-muted-foreground truncate">
