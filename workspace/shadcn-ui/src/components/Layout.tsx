...
export default function Layout({ children }: LayoutProps) {
  ...
  const filteredNavigation = navigation.filter(item => {
    ...
    if (item.name === 'Users') return hasPermission('users', 'view');
    if (item.name === 'Allocation') return hasPermission('allocations', 'view');
    return hasPermission(item.name.toLowerCase(), 'view');
  });
