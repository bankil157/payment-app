          ...
          <div className="flex-1 overflow-y-auto pr-2">
            <div className="space-y-6 py-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="edit-receivedDate" className="text-sm font-medium">Received Date *</Label>
                  <Input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="edit-receivedFromType" className="text-sm font-medium">Received From Type *</Label>
                  <Select value={formData.receivedFromType} onValueChange={(value: 'buyer' | 'broker') => setFormData(prev => ({ ...prev, receivedFromType: value, receivedFromId: '' }))}>
                    <SelectTrigger className="mt-1">
                      <SelectValue placeholder="Select type" />
                    </SelectTrigger>
                ...
                <div>
                  <Label htmlFor="edit-receivedFromId" className="text-sm font-medium">Received From *</Label>
                  <Select value={formData.receivedFromId} onValueChange={(value) => setFormData(prev => ({ ...prev, receivedFromId: value }))}>
                    <SelectTrigger className="mt-1">
                      <SelectValue placeholder={`Select ${formData.receivedFromType}`} />
                    </SelectTrigger>
